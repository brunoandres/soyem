...
<div class="etiqueta">Apellido y Nombre:</div>
  ...
  <input name="nacimiento" type="text" class="p_input" id="nacimiento" value="<?php echo substr($data['nacimiento'],8,2).'/'.substr($data['nacimiento'],5,2).'/'.substr($data['nacimiento'],0,4); ?>" />
