...
$nnro = mysql_fetch_array(mysql_query("select * from asientos order by nro desc"));
$nro = $nnro['nro'];
	mysql_query("insert into pagos (fecha_pago, cuenta_banco, importe_pago, detalle_pago, usuario_pago, factura_pago, empresa_pago, forma_pago, cheque_pago, cuenta_contable_pago, nro_as ) values ('$fecha', '$cuenta_banco', '$importe', '$detalle', '$id_us', '$factura', '$empresa', '$forma', '$nro_cheque', '$cuenta_contable', '$nro')");
