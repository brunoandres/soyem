...
if ($existe>0) {
	...
	mysql_query("insert into familiares (nombre, documento, nacimiento, tipo, nro, id_af, estudio, discapacitado, sexo) values ('$nombre', '$documento', '$nacimiento', '$tipo', '$nro', '$clave', '$estudio', '$discapacitado', '$sexo')");
