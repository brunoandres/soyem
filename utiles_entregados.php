...
<br />
 ...
 <table id="example" class="display" cellspacing="0" width="100%">
	...
	$sq = "select legajo,kit,familiar as afiliado,nombre_familiar from v_utiles where id_fam in (select id_familiar from legajos_utiles) $sql order by afiliado asc";
