...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'REPORTE DE AFILIADOS ACTIVOS Y COSEGURO')
...
/*Extraer datos de MYSQL*/
	...
	$sql="select * from afiliado where activo = 'si' and coseguro ='si' and jubilado = 'no'";
...
$objPHPExcel->getActiveSheet()->setTitle('Reporte de Afiliados Activos');
